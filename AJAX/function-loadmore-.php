...
function enqueue_ajax_scripts()
{
	...
	wp_localize_script( 'load-ajax', 'ajax_form', array(
		'ajaxurl' => admin_url('admin-ajax.php'),
		'ajax_nonce' => wp_create_nonce( 'send_post_data_nonce' )
	));
}
...
{
	// Verify nonce
	if (!isset($_POST['nonce']) || !wp_verify_nonce($_POST['nonce'], 'send_post_data_nonce')) {
